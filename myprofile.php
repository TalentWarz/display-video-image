		...
		<section id="section_1_content">
			...
			<section id="battle">
				...
				?>
						<section id="current_battle">
							<center>
								<span id="no_battle_player_1">
									<?
										if ($my_video != "") {?>
											<name style="color:#d7d7d7;width:250px;"><?echo$player_id;?></name>
									<?
										}
									?>
								</span>
								<br>
								<span id="no_battle_video_1">
									<?
									if ($my_video != '') {
										echo "<video width='250' height='200' controls src='videos/".$my_video."'></video>";
										echo "<br>";
									...
									?>
										...
										?>
											...
											<br>
											<br>
											<center style="color:white;font-size:15px;">(May take a few minutes to upload)</center>
											<form id="upload_video" action="uploadVideo.php" method="post" enctype="multipart/form-data">
												<input type="file" name="file" id="fileToUpload" style="color:white;margin-top:30px;font-size:30px;background-image: url('pictures/carbon.jpg');border:1px solid white;" required><br><br>
										...
										<?php
											if(isset($_POST['submit'])) {
												echo "<center style='color:white;'><br/>".$name." has been uploaded</center>";
											}
